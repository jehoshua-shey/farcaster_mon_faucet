...
export default function ClaimButton() {
    ...
    const [isReady, setIsReady] = useState(false); // Track UI readiness
    ...
    // Check readiness and signal ready to Farcaster
    useEffect(() => {
        if (address && hasClaimed !== null) {
            setIsReady(true);
            // Signal readiness to Farcaster client
            sdk.actions.ready().then(() => {
                console.log('Mini App signaled ready to Farcaster client');
            }).catch((err) => {
